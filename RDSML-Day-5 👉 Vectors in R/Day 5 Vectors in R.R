...
# Logical operator TRUE and FALSE when 
# converted to numeric, TRUE converts to 1
...
# other than 0 converts tom TRUE, 0 converts to FALSE)
d
class(d)
d = as.logical(d)
d
...
my_seq = c(1:50, 80, 10, 99, 88, 60, 77, 61, 92, 97)
my_seq
